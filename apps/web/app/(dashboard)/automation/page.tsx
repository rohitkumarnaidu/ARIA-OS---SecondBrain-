...
const defaultAutomations: Automation[] = [
  {
    ...
    lastRun: { status: 'success', duration: 12, timestamp: new Date(Date.now() - 3 * 3600000).toISOString() },
  },
  {
    ...
    lastRun: { status: 'success', duration: 45, timestamp: new Date(Date.now() - 5 * 3600000).toISOString() },
  },
  {
  ...
  },
  {
    ...
    lastRun: { status: 'success', duration: 8, timestamp: new Date(Date.now() - 22 * 3600000).toISOString() },
  },
]
...
export default function AutomationPage(): JSX.Element {
  ...
  const data = automations.length > 0 ? automations : defaultAutomations
