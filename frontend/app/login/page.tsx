    ...
    <div className="min-h-screen bg-background-dark flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-text-primary mb-2">Second Brain OS</h1>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center">
          <div className="p-4">
            <div className="text-2xl font-bold text-accent-primary mb-1">15+</div>
            <div className="text-xs text-text-muted">Modules</div>
          </div>
          <div className="p-4">
            <div className="text-2xl font-bold text-accent-secondary mb-1">AI</div>
            <div className="text-xs text-text-muted">Powered</div>
          </div>
          <div className="p-4">
            <div className="text-2xl font-bold text-accent-warning mb-1">Free</div>
