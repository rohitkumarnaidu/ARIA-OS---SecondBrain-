...
graph TD
    A["<b>1. Plan</b><br/>Risk assessment &bull; Test estimation"]:::primary --> B["<b>2. Design</b><br/>Test case writing &bull; Automation setup"]:::secondary
    B --> C["<b>3. Execute</b><br/>Manual &amp; automated test runs"]:::primary
    C --> D{"<b>Pass?</b>"}:::accent
    D -->|"✅ Yes"| E["<b>4. Report</b><br/>Metrics &amp; signoff documentation"]:::secondary
    D -->|"❌ No"| F["<b>Bug Fix</b><br/>Developer triage &amp; resolution"]:::warning
    F --> C
    E --> G["<b>5. Retest</b><br/>Regression suite &bull; Smoke tests"]:::primary
    G --> H["<b>6. Release</b><br/>Go/No-Go decision &bull; Production deploy"]:::accent
