...
| `SUPABASE_KEY` | Supabase anon public key | Supabase Dashboard â†’ Settings â†’ API | `fake-jwt-token-string-for-testing...` |
| `SUPABASE_SERVICE_KEY` | Supabase service_role key (secret) | Supabase Dashboard â†’ Settings â†’ API | `fake-jwt-token-string-for-testing...` |
